...
from utils import init_driver, get_last_date_from_csv, log_search_page, keep_scroling, dowload_images, log_in, check_exists_by_link_text, check_exists_by_xpath
...
def scrape(since, until=None, words=None, to_account=None, from_account=None, mention_account=None, interval=5, lang=None,
          ...
          geocode=None, minreplies=None, minlikes=None, minretweets=None, wait=10):
    """
    ...
    log_in(driver, env_path, wait=wait)
    sleep(wait)
...
if __name__ == '__main__':
    ...
    data = scrape(since=since, until=until, words=words, to_account=to_account, from_account=from_account, mention_account=mention_account,
                ...
                display_type=display_type, resume=resume, proxy=proxy, filter_replies=True, proximity=proximity,
                geocode=geocode, minreplies=minreplies, minlikes=minlikes, minretweets=minretweets)
